...
public class IndexPredicate implements Serializable {
     ...
     * @see Predicate
     */
    private final Predicate.Op op;	//operation use to compare
    private final Field fvalue;	//field value to compare 
    ...
    */
    public boolean equals(IndexPredicate ipd) {
    	...
    	if (ipd == null)
    		return false;
    	return fvalue.compare(op, ipd.fvalue);//(op.equals(ipd.op)&&fvalue.equals(ipd.fvalue));
    }
